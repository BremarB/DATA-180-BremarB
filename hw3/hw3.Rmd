...
```{r}
ggplot(Cars93,aes(x=EngineSize, y=MPG.city))+labs(x="Engine Size", y= "MPG.city",title ="Engine size VS MPG.city",subtitle = "By Bremar Brown", xlim=20,ylim=50 )+geom_point(size=2, shape=16, color="blue", fill="blue")
```
...
```{r}
ggplot(Cars93,aes(x=EngineSize, y=MPG.city, colour=Type))+labs(x="Engine Size", y= "MPG.city",title ="Engine size VS MPG.city", subtitle = "By Bremar Brown",xlim=20,ylim=50 )+geom_point(size=2)
```
...
```{r}
ggplot(Cars93,aes(x=EngineSize, y=MPG.city, colour=Type))+labs(x="Engine Size", y= "MPG.city",title ="Engine size VS MPG.city", subtitle = "By Bremar Brown", xlim=20,ylim=50 )+geom_point(size=2) + geom_smooth(method = "loess",se=F,size=1.2,color="red",linetype ="dashed")
```
...
```{r}
ggplot(Cars93,aes(x=AirBags, y="Frequency", colour=Type, fill=Type))+labs(x="Airbag Type", y= "Frequency",title ="Airbag Type",subtitle = "By Bremar Brown",xlim=20,ylim=50 )+geom_bar(stat="identity")
```
...
```{r}
ggplot(Cars93,aes(x=Origin, y="Frequency", fill=AirBags))+labs(x="CarOrigin", y= "Frequency",title ="Airbag Type",subtitle = "By Bremar Brown",xlim=20,ylim=50 )+geom_bar(stat="identity",position = "dodge")
```
...
```{r}
ggplot(data = au_states) + geom_sf(aes(fill=NAME))
```
## Task 3
...
```{r}
ggplot(data = au_states) + geom_sf(data=au_states, colour ="black", fill="NA") + geom_point(data=au_capitals, colour="red",size=2, mapping=aes(x=lon, y=lat))
```
...
```{r}
ggplot(data = au_states) + geom_sf(data=au_states, colour ="black", fill="NA")  + coord_sf(crs=st_crs(3112))
